const portfolioContent = [
  ...
  },
  {
    ...
    firstLink: "/",
    secondLink: "https://github.com/Alpha-Academy-Indonesia",
    firstButtonText: "STILL IN DEVELOPMENT",
    secondButtonText: "VISIT GITHUB REPO",
  },
...
const skillContent = [
  {
    ...
    description:
      "These are the programming languages that I have learned and used in bachelor's degree ",
  },
  {
    title: "Front End",
    links: [
    ...
    description:
      "These are the front-end technologies that I have learned from the internet and used in personal projects and assignments.",
  },
  {
    title: "UI Design",
    links: [
    ...
    description:
      "I use Figma a lot in my projects to design the user interface and user experience of the website or application.",
  },
  {
    title: "Database",
    links: [
    ...
    description:
      "I have learned and used Prisma, PostgreSQL, and MySQL in my projects to manage the database of the website or application.",
  },
  {
    ...
    description:
      "For the version control system, I mostly use Github and Git to manage the source code of the project.",
  },
  {
    title: "On-Progress Learning",
    links: [
      {
    ...
    description:
      "I am currently learning Typescript, Laravel, and Golang to expand my knowledge in web development.",
  },
];
...
const experienceContent = [
  {
    ...
    content: [
      ...
      },
      {
        ...
        title: "Expert Staff of UI Designer",
    ...
    content: [
      {
        ...
        description: [
          "Mastered Python fundamentals for ML/DL, including data wrangling with Pandas",
          "Built a solid foundation in Linear Algebra and Calculus for ML/DL",
          "Implemented Deep Learning models with PyTorch, gaining hands-on experience",
          "Explored Computer Vision techniques like CNNs for image tasks",
          "Delved into NLP with Transformers, covering translation, summarization, sentiment analysis, and built a Real-world NLP app",
        ],
      },
      {
        ...
        description: [
          "TensorFlow Application Skills: Mastered TensorFlow for various projects, created Neural Networks, enhanced image tasks with Convolution, processed text with NLP, trained models for original poetry.",
